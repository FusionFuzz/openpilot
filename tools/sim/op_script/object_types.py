...
# all vehicles only
large_car_types = ['vehicle.carlamotors.carlacola', 'vehicle.tesla.cybertruck']
...
# vehicle_types = large_car_types + car_types
vehicle_types = large_car_types + car_types + motorcycle_types + cyclist_types
