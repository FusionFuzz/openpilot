...
struct RadardData {
  frameId @0 :UInt32;
  leadRadar1 @1 :LeadData;
  leadVision1 @2 :LeadData;
  leadRadar2 @3 :LeadData;
  leadVision2 @4 :LeadData;
  leadPredicted1 @5 :LeadData;
  leadPredicted2 @6 :LeadData;
...
# addition
struct ParametersFromCarla {
  fusion @0 :Text;
  targetSpeed @1 :UInt32;
}
# addition
struct RadarCluster {
  dRel @0 :Float32;
...
struct Event {
  ...
  union {
    ...
    leadCarla @81 :LeadCarla;
    parametersFromCarla @82 :ParametersFromCarla;
    radarClusters @83 :List(RadarCluster);
  }
}
